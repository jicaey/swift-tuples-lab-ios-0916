 ...
 */
var person = ("Calanthe", 205)


/*: question2
 ### 2. Print out "<Name> is <Age> years old" using the tuple you created in Question 1.
 */
print("The formidable \(person.0) displays immense power at only \(person.1) years old")
 ...
 */
var someone = (name: "Pellaz", age: 189)
 ...
 */
let human = (name: "The Supreme Aghama", age: 983)
